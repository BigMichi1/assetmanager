...
class MimeResolver
{
     ...
     * @return string|null null when not found, extension (string) when found.
     */
    public function getExtension(?string $mimetype): ?string
    {
        ...
        if (!($extension = array_search($mimetype, $this->mainMimeTypes, true))) {
            $extension = array_search($mimetype, $this->mimeTypes, true);
        }
